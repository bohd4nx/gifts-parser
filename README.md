...
<p align="center">
  <a href="https://github.com/bohd4nx/gifts-parser/blob/main/README.md">English</a> |
  · Русский ·
</p>
...
4. По окончании бот предложит скачать результаты:
   ...
   [ Download Results ]
   ```
5. Нажав «Download Results», вы получите файл со списком пользователей и информацией о найденных подарках.
